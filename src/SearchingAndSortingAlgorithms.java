...
public class SearchingAndSortingAlgorithms {
	...
	public void testFindString() throws Exception {
		List<String> cheese = Arrays.asList(".... . .-. .-. --- / ... --- ... / -.-- .- .-.. .-.. ...".split("/"));
		assertEquals(true, Algorithms.containsSOS(cheese));
	...
	public void testSort() throws Exception {
		...
		assertEquals(Double.valueOf(38.4), Algorithms.sortScores(new ArrayList<Double>(results)).get(0));
		assertEquals(Double.valueOf(40.7), Algorithms.sortScores(new ArrayList<>(results)).get(1));
		assertEquals(Double.valueOf(95.0), Algorithms.sortScores(new ArrayList<>(results)).get(13));
	}
	...
	// 8. Sort the DNA sequences by length from shortest to longest. 
	 ...
	 assertEquals(sortedSequences, Algorithms.sortDNA(new ArrayList<String>(unsortedSequences)));
	 }
	 ...
	 */
	 ...
	 "ait", "dal", "daw" });
	 assertEquals("aby", Algorithms.sortWords(new ArrayList<String>(words)).get(0));
	 assertEquals("bar", Algorithms.sortWords(new ArrayList<String>(words)).get(10));
	 assertEquals("daw", Algorithms.sortWords(new ArrayList<String>(words)).get(words.size() - 1));
	 }
